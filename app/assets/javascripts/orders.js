...
$(document).ready(function() {
    ...
    $(".qty").on("focusout keypress", function(e){
        ...
        if (thisorigqty == 0){         // so need to create an order record.
            ...
            $.ajax({
                type: 'POST',
                url: "https://hidden-sea-17611.herokuapp.com/orders",
                data: {
                        order: {
            ...
            $.ajax({
                type: 'DELETE',
                url: "https://hidden-sea-17611.herokuapp.com/orders/" + myorder_id,
                dataType: 'json',
                success: function(){
                    $(eleorigqty).text("");
                    $(eleqty).val("");
            ...
            $.ajax({
                type: 'POST',
                url: "https://hidden-sea-17611.herokuapp.com/orders/" + Number($(this).attr("id")),
